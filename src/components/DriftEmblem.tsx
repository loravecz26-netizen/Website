...
export default function DriftEmblem() {
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      for (const s of streams) {
        ...
        ctx.closePath();
        ctx.strokeStyle = `rgba(100,74,64,${s.alpha})`;
  ...
  return (
    <section ref={ref} className="relative py-40 flex flex-col items-center overflow-hidden bg-muted">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_60%_at_50%_50%,rgba(100,74,64,0.08),transparent)]" />
      ...
      >
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center gap-3">
          <div
            ...
            style={{
              background: "radial-gradient(circle at 40% 35%, #ffdfb5, #644a40 60%, #3d1a10)",
            }}
          >
              ...
              <svg width="44" height="44" viewBox="0 0 44 44" fill="none">
                ...
                <defs>
                  <linearGradient id="primaryGrad" x1="0" y1="0" x2="44" y2="44" gradientUnits="userSpaceOnUse">
                    <stop offset="0%" stopColor="#ffdfb5" />
