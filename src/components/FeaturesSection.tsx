...
export default function FeaturesSection() {
  ...
  return (
    <section ref={ref} id="solutions" className="relative py-32 px-6 md:px-10 bg-background">
      <div
        className="absolute inset-0 pointer-events-none"
        style={{ background: "radial-gradient(ellipse 70% 40% at 50% 0%, color-mix(in srgb, var(--primary) 4%, transparent), transparent)" }}
      />
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-px bg-primary/[0.08] rounded-2xl overflow-hidden border border-primary/10">
