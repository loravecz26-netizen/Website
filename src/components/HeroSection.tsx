  ...
  useEffect(() => {
    ...
    const buildStarField = () => {
      ...
      for (let layer = 0; layer < 3; layer++) {
        ...
        for (let j = 0; j < COUNT; j++) {
          ...
          else if (roll < 0.88)  c.setHSL(0.07, 0.65, 0.82);                        // warm peach
          else                   c.setHSL(0.05, 0.40, 0.90);                        // soft warm
    ...
    const buildNebula = () => {
      ...
      const mat  = new THREE.ShaderMaterial({
        uniforms: {
          time:    { value: 0 },
          color1:  { value: new THREE.Color(0xffe0c2) }, // peach primary
          color2:  { value: new THREE.Color(0x3d1a10) }, // dark brown
          opacity: { value: 0.28 },
        },
        vertexShader: `
          varying vec2 vUv;
      ...
      const mat  = new THREE.ShaderMaterial({
        ...
        fragmentShader: `
          ...
          void main() {
            ...
            vec3 atm = vec3(1.0, 0.878, 0.757) * i;
